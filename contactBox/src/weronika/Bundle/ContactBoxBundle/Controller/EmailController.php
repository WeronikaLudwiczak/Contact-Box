...
namespace weronika\Bundle\ContactBoxBundle\Controller;
...
use weronika\Bundle\ContactBoxBundle\Entity\Email;
use weronika\Bundle\ContactBoxBundle\Form\EmailType;
...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('weronikaContactBoxBundle:Email')->findAll();
     ...
     * @Method("POST")
     * @Template("weronikaContactBoxBundle:Email:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('weronikaContactBoxBundle:Email')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("weronikaContactBoxBundle:Email:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('email_show', array('id' => $id)));
        }
