...
use weronika\Bundle\ContactBoxBundle\Entity\Phone;
use weronika\Bundle\ContactBoxBundle\Form\PhoneType;
...
class PhoneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('weronikaContactBoxBundle:Phone')->findAll();
     ...
     * @Method("POST")
     * @Template("weronikaContactBoxBundle:Phone:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('weronikaContactBoxBundle:Phone')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("weronikaContactBoxBundle:Phone:edit.html.twig")
     */
