...
use weronika\Bundle\ContactBoxBundle\Entity\Address;
use weronika\Bundle\ContactBoxBundle\Form\AddressType;
...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('weronikaContactBoxBundle:Address')->findAll();
     ...
     * @Method("POST")
     * @Template("weronikaContactBoxBundle:Address:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('weronikaContactBoxBundle:Address')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("weronikaContactBoxBundle:Address:edit.html.twig")
     */
